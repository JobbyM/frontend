...
### 0 - 1 背包问题
该问题可以描述为：给定一组物品，每种物品都有自己的重量和价格，在限定的总重量内，我们如何选择，才能使得物品的总价格最高。每个物品只能放入至多一次。
...
如果你对于 Trie 树还不怎么了解，可以前往 [这里](../datastruct/#tire) 阅读